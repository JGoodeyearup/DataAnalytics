...
# I feel it would be more efficient to use the match case statement because it's easier to read and more straight to the point.
# The if statement is easier to start with for me because I am more familiar with it but I think the more I use match case the more comfortable I'll be with it. 